...
`python3 -m cartpole.run_experiments control` runs Q-learning and SARSA
`python3 -m cartpole.run_experiments prediction` runs TD(0) and Monte-Carlo
`python3 -m cartpole.run_experiments sensitivity` runs sensitivity analysis
`python3 -m cartpole.run_experiments failure`
